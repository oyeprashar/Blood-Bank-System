...
public interface FindPasswordResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:farm.nurture.core.contracts.BloodBankSystemService.FindPasswordResponse)
   ...
   */
  java.util.List<farm.nurture.farm.service.proto.FindPasswordResponseRecord> 
      getRecordsList();
  /**
   * <code>repeated .farm.nurture.core.contracts.BloodBankSystemService.FindPasswordResponseRecord records = 4;</code>
   */
  farm.nurture.farm.service.proto.FindPasswordResponseRecord getRecords(int index);
  /**
   * <code>repeated .farm.nurture.core.contracts.BloodBankSystemService.FindPasswordResponseRecord records = 4;</code>
   */
  int getRecordsCount();
   ...
   * <code>repeated .farm.nurture.core.contracts.BloodBankSystemService.FindPasswordResponseRecord records = 4;</code>
   */
  java.util.List<? extends farm.nurture.farm.service.proto.FindPasswordResponseRecordOrBuilder> 
      getRecordsOrBuilderList();
  /**
   * <code>repeated .farm.nurture.core.contracts.BloodBankSystemService.FindPasswordResponseRecord records = 4;</code>
   */
  farm.nurture.farm.service.proto.FindPasswordResponseRecordOrBuilder getRecordsOrBuilder(
      int index);
}
